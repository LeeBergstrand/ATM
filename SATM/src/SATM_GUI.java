...
public class SATM_GUI extends javax.swing.JFrame {
    ...
    private void checkDeposit()
    {
        if (keynums.size() == 4){
            ...
            int deposit = Integer.parseInt(pinString);
            USERBalance += deposit;
            keynums.clear();
    ...
    private void checkWithdrawal()
    {
        if (keynums.size() == 4){
            ...
            int withdrawal = Integer.parseInt(pinString);
            keynums.clear();
    ...
    private void keypadYesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keypadYesActionPerformed
        if (state == 3) {
            output.setText("Select transaction: balance > deposit > withdrawal >");
            state = 2;
        }
    ...
    private void keypadNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keypadNoActionPerformed
        if (state == 3) {
    ...
    private void collectCardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_collectCardActionPerformed
        if (state == 4) {
            output.setText("Welcome please insert your ATM card");
            state = 0;
        }
